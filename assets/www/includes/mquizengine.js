...
function Quiz(){
	...
	this.setHeader = function(){
		...
		$('#quizheader').html("Question " +(this.currentQuestion+1) + " of "+ this.quiz.q.length);
	}
	...
	this.showResults = function(){
		...
		inQuiz = false;
		$('#content').empty();
		$('#content').append("<h2>Your results for:<br/> '"+ this.quiz.title +"'</h2>");
		// calculate score
		var total = 0;
		...
		var retake = $('<div>').attr({'class': 'resultopt clickable centre'}).append('Try again');
